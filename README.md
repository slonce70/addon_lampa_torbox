...
- В списке эпизодов: `Right` с серии -> кнопка `⬇`, OK на `⬇` получает ссылку для загрузки, копирует её и при возможности открывает внешне; `Left` возвращает на серию.
