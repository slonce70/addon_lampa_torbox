...
- `API key`: ключ TorBox — обязателен для запросов к TorBox. Укажите собственный ключ; плагин не содержит и не использует общий встроенный ключ.
...
### 51.2.10
- Удалён встроенный TorBox API-ключ: теперь для запросов к TorBox требуется собственный ключ пользователя.
...
- Ранее был добавлен дефолтный API-ключ TorBox; удалён в 51.2.10 по соображениям безопасности.
