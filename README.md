...
> **Версия 51.1.3 (Стабильная)**
>
> Релиз сфокусирован на автономности плагина и контроле за поведением интерфейса:
>
> - **Управление с пульта:** правый переход сразу попадает в панель фильтров, вверх открывает доступ к фильтрам и поиску без лишних прыжков.
