/*
 * TorBox Enhanced – Universal Lampa Plugin v26.1.0 (Initialization Fix)
 * =================================================================================
 * • ВИПРАВЛЕННЯ ІНІЦІАЛІЗАЦІЇ: Усунуто синтаксичну помилку, що виникала через
 * неправильну структуру коду. Вся логіка ініціалізації обгорнута у функцію
 * initPlugin(), що забезпечує коректне завантаження плагіна.
 * • Збережено гібридний підхід: стабільний UI на основі Lampa.Explorer
 * та сучасний API-двигун з публічними парсерами.
 */
...
(function () {
  ...
  /* ───── Guard double-load ───── */
  const PLUGIN_ID = 'torbox_enhanced_v26_1_0_init_fix';
